...
function () {
  function XPath(parser, path) {
    ...
    this.parser = parser;
    this.path = path;
    this.elements = this.split(path); // console.log(this.elements.toString());
  ...
  (0, _createClass2["default"])(XPath, [{
    ...
    value: function split(path) {
      ...
      var tokens = tokenStream.getTokens(); // console.log("path=" + path + "=>" + tokens);
    ...
    value: function evaluate(t) {
      ...
      while (i < this.elements.length) {
        ...
        try {
          for (var _iterator = work[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
