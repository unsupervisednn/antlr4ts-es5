...
function (_ATNSimulator_1$ATNSi) {
  ...
  function ParserATNSimulator(atn, parser) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(ParserATNSimulator).call(this, atn));
  ...
  (0, _createClass2["default"])(ParserATNSimulator, [{
    ...
    key: "reset",
    value: function reset() {// intentionally empty
    }
  }, {
    key: "adaptivePredict",
    ...
    value: function execDFA(dfa, input, startIndex, state) {
      ...
      if (!state.useContext && s.configs.conflictInfo != null) {
        if (dfa.atnStartState instanceof DecisionState_1.DecisionState) {
          if (!this.userWantsCtxSensitive || !s.configs.dipsIntoOuterContext && s.configs.isExactConflict || this.treat_sllk1_conflict_as_ambiguity && input.index === startIndex) {// we don't report the ambiguity again
            ...
            assert(!state.useContext); // Before attempting full context prediction, check to see if there are
    ...
    value: function execATN(dfa, input, startIndex, initialState) {
      ...
      while (true) {
        ...
        var D = nextState.s0; // predicted alt => accept state
        ...
        if (this.isAcceptState(D, useContext)) {
          ...
          predictedAlt = D.prediction; //				int k = input.index - startIndex + 1; // how much input we used
    ...
    value: function handleNoViableAlt(input, startIndex, previous) {
      if (previous.s0 != null) {
        ...
        try {
          for (var _iterator = previous.s0.configs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        switch (alts.cardinality()) {
          ...
          default:
            ...
            try {
              for (var _iterator2 = previous.s0.configs[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function computeTargetState(dfa, s, remainingGlobalContext, t, useContext, contextCache) {
      ...
      do {
        ...
        try {
          for (var _iterator3 = closureConfigs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var _c = _step3.value;
        ...
        if (skippedStopStates != null && (!useContext || !PredictionMode_1.PredictionMode.hasConfigInRuleStopState(reach))) {
          ...
          try {
            for (var _iterator4 = skippedStopStates[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              var c = _step4.value;
        ...
        if (useContext && stepIntoGlobal) {
          reach.clear(); // We know remainingGlobalContext is not undefined at this point (why?)
    ...
    value: function removeAllConfigsNotInRuleStopState(configs, contextCache) {
      ...
      try {
        for (var _iterator5 = configs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function computeStartState(dfa, globalContext, useContext) {
      ...
      var decision = dfa.decision; // @NotNull
      ...
      while (true) {
        ...
        _next.setContextSensitive(this.atn); // We know remainingGlobalContext is not undefined at this point (why?)
    ...
    value: function applyPrecedenceFilter(configs, globalContext, contextCache) {
      ...
      try {
        for (var _iterator6 = configs[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      try {
        for (var _iterator7 = configs[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    value: function predicateDFAState(D, configs, nalts) {
      ...
      var altToPred = this.getPredsForAmbigAlts(conflictingAlts, configs, nalts); // altToPred[uniqueAlt] is now our validating predicate (if any)
    ...
    value: function getPredsForAmbigAlts(ambigAlts, configs, nalts) {
      ...
      try {
        for (var _iterator8 = configs[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          var c = _step8.value;
    ...
    value: function evalSemanticContext(predPredictions, outerContext, complete) {
      ...
      try {
        for (var _iterator9 = predPredictions[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
    ...
    value: function closure(sourceConfigs, configs, collectPredicates, hasMoreContext, contextCache, treatEofAsEpsilon) {
      ...
      while (currentConfigs.size > 0) {
        ...
        try {
          for (var _iterator10 = currentConfigs[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
    ...
    value: function closureImpl(config, configs, intermediate, closureBusy, collectPredicates, hasMoreContexts, contextCache, depth, treatEofAsEpsilon) {
      ...
      if (config.state instanceof RuleStopState_1.RuleStopState) {
        ...
        if (!config.context.isEmpty) {
          ...
          for (var i = 0; i < nonEmptySize; i++) {
            ...
            var c = ATNConfig_1.ATNConfig.create(returnState, config.alt, newContext, config.semanticContext); // While we have context to pop back from, we may have
      ...
      if (!p.onlyHasEpsilonTransitions) {
        configs.add(config, contextCache); // make sure to not return here, because EOF transitions can act as
      ...
      for (var _i = 0; _i < p.numberOfOptimizedTransitions; _i++) {
        ...
        if (_i === 0 && p.stateType === ATNStateType_1.ATNStateType.STAR_LOOP_ENTRY && p.precedenceRuleDecision && !config.context.hasEmpty) {
          var precedenceDecision = p; // When suppress is true, it means the outgoing edge i==0 is
    ...
    value: function isConflicted(configset, contextCache) {
      ...
      try {
        for (var _iterator11 = configs[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      ...
      if (exact) {
        currentState = configs[0].state.nonStopStateNumber; // get the represented alternatives of the first state
        ...
        try {
          for (var _iterator12 = configs[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        ...
        try {
          for (var _iterator13 = configs[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
    ...
    value: function dumpDeadEndConfigs(nvae) {
      ...
      try {
        for (var _iterator14 = deadEndConfigs[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
          var c = _step14.value;
          var trans = "no edges";
    ...
    value: function getUniqueAlt(configs) {
      ...
      try {
        for (var _iterator15 = configs[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
          var c = _step15.value;
    ...
    value: function configWithAltAtStopState(configs, alt) {
      ...
      try {
        for (var _iterator16 = configs[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
          var c = _step16.value;
    ...
    value: function addDFAEdge(dfa, fromState, t, contextTransitions, toConfigs, contextCache) {
      ...
      if (contextTransitions != null) {
        ...
        try {
          for (var _iterator17 = contextTransitions.toArray()[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
    ...
    value: function addDFAContextState(dfa, configs, returnContext, contextCache) {
      if (returnContext !== PredictionContext_1.PredictionContext.EMPTY_FULL_STATE_KEY) {
        ...
        try {
          for (var _iterator18 = configs[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
    ...
    value: function addDFAState(dfa, configs, contextCache) {
      ...
      var newState = this.createDFAState(dfa, configs.clone(true)); // getDecisionState won't return undefined when we request a known valid decision
    ...
    key: "reportAmbiguity",
    value: function reportAmbiguity(dfa, D, // the DFA state from execATN(): void that had SLL conflicts
