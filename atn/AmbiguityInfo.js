...
function (_DecisionEventInfo_1$) {
  ...
  function AmbiguityInfo(decision, state, ambigAlts, input, startIndex, stopIndex) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(AmbiguityInfo).call(this, decision, state, input, startIndex, stopIndex, state.useContext));
